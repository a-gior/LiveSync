...
export class FileStatusDecorationProvider implements vscode.FileDecorationProvider {
  private readonly decorationData = new Map<ComparisonStatus, vscode.FileDecoration>();
  ...
  provideFileDecoration(
    ...
    const fileEntryStatus: ComparisonStatus = ComparisonStatus[status as keyof typeof ComparisonStatus];
